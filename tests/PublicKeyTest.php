...
class PublicKeyTest extends TestCase
{
    ...
    public function testFromStringAcceptsLegacyMldsa44Prefix(): void
    {
        $bytes = str_repeat("\x42", SigningAlgorithm::MLDSA44->publicKeyLength());
        $legacy = 'mldsa44:' . sodium_bin2base64($bytes, SODIUM_BASE64_VARIANT_URLSAFE_NO_PADDING);

        $pk = PublicKey::fromString($legacy);
        $this->assertSame(SigningAlgorithm::MLDSA44, $pk->getAlgo());
        $this->assertStringStartsWith('ml-dsa-44:', $pk->toString());
    }
